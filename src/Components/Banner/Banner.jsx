...
const Banner = ({handleClaimFreeBtn}) => {
    ...
    return (
        <div className="bg-gradient-to-r from-black via-blue-900 to-purple-900 rounded-xl py-8 px-4 sm:py-12 sm:px-6 flex flex-col items-center justify-center text-center shadow-lg my-6">
            <div className="space-y-5">
                ...
                <button onClick={handleClaimFreeBtn} className="btn bg-amber-300 border-4 border-double border-amber-950 rounded-lg">Claim Free Credit</button>
            </div>
        </div>
    );
};
